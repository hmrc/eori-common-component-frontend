...
cds.if.you.need.help.telephone2=Dydd Llun i ddydd Gwener, 08:00 i 18:00 (gwyliau banc caeedig)
cds.if.you.need.help.telephone.link=Darganfyddwch fwy am daliadau galwadau
...
#Get An EORI Journey
# Start Page
cds.start-page.title=POST_MVP Get a GB EORI number

cds-start-page.intro1=POST_MVP From 1st January 2021 if you want to move goods between Great Britain (England, Scotland and Wales) and the rest of the world you may need a GB Economic Operator and Registration Identification (EORI) number.
cds-start-page.intro2=POST_MVP HMRC uses this to identify you and collect duty on your goods.
cds-start-page.intro3=POST_MVP If you do not get a GB EORI number you may experience increased costs and delays. For example, if HMRC cannot clear your goods you may have to pay storage fees.

cds.start-page.ni.heading=POST_MVP If you move goods to or from Northern Ireland
cds.start-page.ni.paragraph1=POST_MVP From 1 January 2021 you’ll need an EORI number that starts with XI to:
cds.start-page.ni.paragraph1.bullet1=POST_MVP move goods between Northern Ireland and non-EU countries
cds.start-page.ni.paragraph1.bullet2=POST_MVP make a declaration in Northern Ireland
cds.start-page.ni.paragraph1.bullet3=POST_MVP get a customs decision in Northern Ireland
cds.start-page.ni.paragraph2=POST_MVP To get an EORI number that starts with XI, you must already have an EORI number that starts with GB. If you do not have one, apply for an EORI number that starts with GB as soon as possible.
cds.start-page.ni.paragraph3=POST_MVP If you already have an EORI number that starts with GB and HMRC thinks you need one that starts with XI, they’ll automatically send you one in mid-December 2020.
cds.start-page.ni.paragraph4=POST_MVP To get advice on moving goods between Great Britain and Northern Ireland sign up for the {0}.
cds.start-page.ni.paragraph4.link=POST_MVP Trader Support Service

cds.start-page.get.heading=POST_MVP To get an EORI number you will need
cds.start-page.get.bullet1=POST_MVP VAT number (if registered), the postcode of the registered VAT address and the effective date - this is on your VAT registration certificate
cds.start-page.get.bullet2=POST_MVP National Insurance number (if you are an individual or sole trader)
cds.start-page.get.bullet3=POST_MVP Unique Taxpayer Reference (UTR). This will be on tax returns and other letters about Self Assessment
cds.start-page.get.paragraph1=POST_MVP You will also need
cds.start-page.get.bullet4=POST_MVP registered company name
cds.start-page.get.bullet5=POST_MVP date the business was registered
cds.start-page.get.bullet6=POST_MVP Standard Industrial Classification (SIC) code for the business
cds.start-page.get.paragraph2=POST_MVP This information can be found on the {0}
