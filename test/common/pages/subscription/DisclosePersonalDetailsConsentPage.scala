...
trait DisclosePersonalDetailsConsentPage extends WebPage {
  ...
  val url: String = frontendHost + "/customs-enrolment-services/register-for-cds/disclose-personal-details-consent"
  ...
  val consentInfoXpath = "//*[@id='yes-no-answer-fieldset']/legend/p"
