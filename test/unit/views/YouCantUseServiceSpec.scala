...
import uk.gov.hmrc.customs.rosmfrontend.views.html.subscription.sub02_request_not_processed
import uk.gov.hmrc.customs.rosmfrontend.views.html.you_cant_use_service
...
class YouCantUseServiceSpec extends ViewSpec {
  ...
  "You cannot use this service page for users of type standard org" should {
    ...
    "have a Sign out button with the correct href" in {
      standardOrgDoc.body().getElementsByClass("button").attr("href") mustBe "/customs-enrolment-services/subscribe-for-cds/logout"
    }
  }
  ...
  "You cannot use this service page for users of type agent" should {
    ...
    "have a Sign out button with the correct href" in {
      agentDoc.body().getElementsByClass("button").attr("href") mustBe "/customs-enrolment-services/subscribe-for-cds/logout"
    }
  }
