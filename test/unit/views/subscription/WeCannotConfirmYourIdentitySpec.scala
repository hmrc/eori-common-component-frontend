...
import uk.gov.hmrc.customs.rosmfrontend.views.html.subscription.we_cannot_confirm_your_identity
...
class WeCannotConfirmYourIdentitySpec extends ViewSpec {
  ...
  private val view = app.injector.instanceOf[we_cannot_confirm_your_identity]
  ...
  "The 'We cannot confirm your identity' Page" should {
    ...
    "have the VAT Details link for the try again button" in {
      doc
        ...
        .attr("href") mustBe "/customs-enrolment-services/register-for-cds/what-are-your-uk-vat-details"
    }
    ...
    "have the VAT Details link for the try again button in review mode" in {
      ...
      doc
        .body()
        .getElementById("try-again")
        .attr("href") mustBe "/customs-enrolment-services/register-for-cds/what-are-your-uk-vat-details/review"
    }
  }
