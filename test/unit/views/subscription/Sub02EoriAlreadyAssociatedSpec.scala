...
import uk.gov.hmrc.customs.rosmfrontend.views.html.subscription.sub02_eori_already_associated
...
class Sub02EoriAlreadyAssociatedSpec extends ViewSpec {
  ...
  private val view = app.injector.instanceOf[sub02_eori_already_associated]
