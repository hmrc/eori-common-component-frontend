  ...
  "Check Your Answers Page" should {
    ...
    "display the review page for 'SoleTrader' with 'Nino'" in {
      ...
      page.body
        ...
        .attr("href") mustBe "/eori-common-component/subscribe-for-cds/matching/what-is-your-eori/review"
      ...
      page.body
        ...
        .attr("href") mustBe "/eori-common-component/subscribe-for-cds/address/review"
      ...
      page.body.getElementById("review-tbl__start-again").attr("href") mustBe "/eori-common-component/subscribe-for-cds/start-again"
    }
