...
class WhenEoriIssuedControllerSpec
  ...
  private val WhenEoriIssuedInFutureErrorPage =
    "Month and year this EORI number was issued must be this month or in the past"

  private val WhenEoriIssuedInFutureErrorField =
    "Error: Month and year this EORI number was issued must be this month or in the past"
