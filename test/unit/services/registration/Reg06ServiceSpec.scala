...
import uk.gov.hmrc.customs.rosmfrontend.services.mapping.{OrganisationTypeConfiguration, RegistrationDetailsCreator}
import uk.gov.hmrc.customs.rosmfrontend.services.registration.Reg06Service
