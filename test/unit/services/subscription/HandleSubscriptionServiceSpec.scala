...
import uk.gov.hmrc.eoricommoncomponent.frontend.models.{Journey, Subscribe}
...
class HandleSubscriptionServiceSpec extends UnitSpec with MockitoSugar with BeforeAndAfter {
  ...
  val recipientDetails: RecipientDetails =
    RecipientDetails(Subscribe.value, atarService.code, "Advance Tariff Rulings", "", "", None, None)
