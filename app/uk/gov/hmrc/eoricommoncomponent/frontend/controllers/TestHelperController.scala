    ...
    val res = payloadKey match {
      case PayloadCache.SubscriptionCreate =>
        ...
        val payload = someData match {
          ...
          case _ =>
            throw new IllegalArgumentException("SubscriptionRequest did not include expected PayloadCache object")
        }
        Json.toJson(payload)
        ...
        val payload = someData match {
          ...
          case _ =>
            throw new IllegalArgumentException(
              "RegisterWithEoriAndIdRequest did not include expected ResponseDetail object"
            )
        }
        Json.toJson(payload)
