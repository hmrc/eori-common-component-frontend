...
class WhatIsYourEoriGBController @Inject() (
  ...
  whatIsYourEoriView: what_is_your_eori_gb
  ...
  private def eoriWithoutCountry(eori: String): String = eori.stripPrefix("GB")

  private def eoriWithCountry(eori: String): String = if (eori.startsWith("GB")) eori else "GB" + eori
