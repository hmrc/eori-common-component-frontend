...
case class HandleSubscriptionRequest(
...
object HandleSubscriptionRequest {
  implicit val jsonFormat: OFormat[HandleSubscriptionRequest] = Json.format[HandleSubscriptionRequest]
}
